...
public class ProductServices {
	...
	//private static final String SELECT_BILL_DETAILS = "SELECT * FROM CUSTOMER_BILL_DETAILS WHERE DATE(BILL_DATE_TIME) BETWEEN ? AND ? ORDER BY BILL_DATE_TIME ASC";
	...
	public static StatusDTO addProduct(Product product) {
		Connection conn = null;
		PreparedStatement stmt = null;
	...
	public static boolean deleteProduct(int prdouctCode) {
		Connection conn = null;
		PreparedStatement stmt = null;
		boolean flag=false;
		try {
	...
	public static StatusDTO updateProduct(Product product) {
		Connection conn = null;
		PreparedStatement stmt = null;
		StatusDTO status = new StatusDTO();
		try {
	...
	public static List<Product> searchProduct(String searchString) {
		Connection conn = null;
		PreparedStatement stmt = null;
		Product pc = null;
		List<Product> productList = new ArrayList<Product>();
	...
	//Save Bill Details
	public static StatusDTO saveBillDetails(BillDetails bill) {
		Connection conn = null;
		PreparedStatement stmt = null;
	...
	//Save Bill Details
		public static boolean saveBillItemDetails(List <ItemDetails> itemList) {
			Connection conn = null;
			PreparedStatement stmt = null;
			boolean flag=false;
		...
		public static boolean updateProductStock(List <ItemDetails> itemList) {
			Connection conn = null;
			PreparedStatement stmt = null;
			boolean flag=false;
		...
		public static List<ItemDetails> getItemDetails(int billNumber){
		...
		public static HashMap<Long,Product> getProductBarCodeMap(){
		...
		public static List<Product> getZeroStockProducts() {
			Connection conn = null;
			PreparedStatement stmt = null;
			Product pc = null;
			List<Product> productList = new ArrayList<Product>();
		...
		public static List<Product> getProductsWithNoBarcode() {
			Connection conn = null;
			PreparedStatement stmt = null;
			Product pc = null;
			List<Product> productList = new ArrayList<Product>();
		...
		public static StatusDTO saveBarcode(Product product) {
			Connection conn = null;
			PreparedStatement stmt = null;
			StatusDTO status = new StatusDTO();
			try {
	...
	//Update Product Stock
	public static boolean quickStockCorrection(Product product) {
		Connection conn = null;
		PreparedStatement stmt = null;
		boolean flag=false;
	...
	public static BillDetails getBillDetailsOfBillNumberWithinDateRange(Integer billNumber,Date fromDate,Date toDate) {
		Connection conn = null;
		PreparedStatement stmt = null;
		BillDetails billDetails=null;
		try {
	...
	public static BillDetails getBillDetailsOfBillNumber(Integer billNumber) {
		Connection conn = null;
		PreparedStatement stmt = null;
		BillDetails billDetails=null;
		try {
	...
	public static StatusDTO updateProductPurchasePrice(List<Product> productList) {
		Connection conn = null;
		PreparedStatement stmt = null;
		StatusDTO status = new StatusDTO();
		try {
