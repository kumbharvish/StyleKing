...
public class SalesReturnServices {
	...
	//Save Return Details
	public static StatusDTO saveReturnDetails(ReturnDetails bill) {
	...
	//Update Item Stock
	private static StatusDTO updateProductStock(List<ItemDetails> itemList) {
		Connection conn = null;
		PreparedStatement stmt = null;
		StatusDTO status = new StatusDTO();
		try {
	...
	private static StatusDTO saveReturnItemDetails(List<ItemDetails> itemList) {
		Connection conn = null;
		PreparedStatement stmt = null;
		StatusDTO status = new StatusDTO();
		try {
	...
	public static ReturnDetails getReturnDetails(Integer billNumber) {
		Connection conn = null;
		PreparedStatement stmt = null;
	...
	public static ReturnDetails getReturnDetailsForReturnNo(Integer returnNumber) {
		Connection conn = null;
		PreparedStatement stmt = null;
		ReturnDetails returnDetails = null;
		try {
	...
	private static StatusDTO updateBillItemsDetails(List<ItemDetails> itemList) {
		Connection conn = null;
		PreparedStatement stmt = null;
		StatusDTO status = new StatusDTO();
		try {
	...
	public static StatusDTO isSalesReturned(int billNumber) {
		Connection conn = null;
		PreparedStatement stmt = null;
	...
	public static List<ItemDetails> getReturnedItemDetails(Integer returnNumber){
	...
	//Get Bill Details
	public static List<ReturnDetails> getReturnDetails(Date fromDate,Date toDate,Long customerMobile) {
		Connection conn = null;
		PreparedStatement stmt = null;
		ReturnDetails returnDetails=null;
		List<ReturnDetails> returnDetailsList = new ArrayList<ReturnDetails>();
		StringBuilder SELECT_BILL_DETAILS = new StringBuilder("SELECT SRD.*,CD.CUST_NAME AS CUSTOMER_NAME FROM SALES_RETURN_DETAILS SRD,CUSTOMER_DETAILS CD WHERE DATE(SRD.RETURN_DATE) BETWEEN ? AND ?  AND SRD.CUST_MOB_NO=CD.CUST_MOB_NO ");
