...
public class ReportServices {
	...
	//Get Total Amount of Sales except pending bills
		public static List<CashCounter> getCashCounterDetails(Date fromDate,Date toDate) {
			...
			try {
					...
					if (rs4.next()) {
						...
						cashTotalCustSettlement.setClosingBalance(closingBalance +rs4.getDouble("TOTAL_CUST_SETTLEMENT_AMOUNT"));
		...
		//Get Opening Cash
		public static Double getOpeningCash(Date date) {
			Connection conn = null;
			PreparedStatement stmt = null;
	...
	// Get Monthly Report
	public static MonthlyReport getMonthlyReport(Date fromDate,Date toDate){
	...
	public static ProfitLossDetails getProfitLossStatment(Date fromDate,Date toDate){
	...
	public static ProfitLossDetails getProfitLossReport(Date fromDate,Date toDate){
		//Debits
		List<ProfitLossData> debit = new ArrayList<ProfitLossData>();
		ProfitLossDetails report = new ProfitLossDetails();
		Connection conn = null;
	...
	public static Double getOpeningStockValue(Date date) {
		Connection conn = null;
		PreparedStatement stmt = null;
	...
	public static Double getStockValueAmount() {
		Connection conn = null;
		PreparedStatement stmt = null;
	...
	public static StatusDTO insertOpeningStockValue(Date date,double amount) {
		Connection conn = null;
		PreparedStatement stmt = null;
	...
	public static StatusDTO addOpeningStockAmount(Date date,double amount){
	...
	public static StatusDTO doRecurrsiveInsertOpeningAmount(){
		StatusDTO status =  new StatusDTO(-1);
	...
	//Get Stock Value Amount
	public static List<Customer> getSettledCustomerList(Date date) {
	...
	public static void main(String[] args) {
		//System.out.println(getProfitLossStatment(new Date(System.currentTimeMillis()),new Date(System.currentTimeMillis())));
		//System.out.println(getOpeningStockValue(new Date(System.currentTimeMillis())));
